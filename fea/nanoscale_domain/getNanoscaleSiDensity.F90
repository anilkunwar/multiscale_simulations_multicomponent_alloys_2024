    ...
    ! (rho_si)solid = As*(T-298) +  Cs, where As = -0.02634103715534164 kg/m3K  and Cs = 2329.757435145345 kg/m3
    ! 298 < T < Tm where Tm = 842.710 K
    !(rho_si)liquid  = Al*(T-1687) + Cl, where Al = -0.3010463148205069 kg/m3K  and Cl = 2559.9615325490504 kg/m3 (1687.0 K < T < 2500.0 K)
